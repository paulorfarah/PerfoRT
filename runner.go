...
func randoop() {
	...
	// c := "java -classpath /mnt/sda4/go-work/src/github.com/paulorfarah/repos/" + repo + "/target/classes:$RANDOOP_JAR randoop.main.Main gentests --testclass=testproject.Test > testproject.Test.txt"
