...
func ParseProfilingClock(db *gorm.DB, clockType string, commitID uint, testcase models.TestCase, output string) {

	e := os.Rename("profiler/"+clockType+".txt", output)
	if e != nil {
